...
values on both their arms. Following is a list of all parameters used for the Goore game:
\begin{itemize}
\item Initial mean of both arms
\item Initial standard deviation of both arms
\item Number of bandits
\item Unimodal performance function
...
is high enough to ensure that each arm is chosen atleast once. We tested between 2 and 10 bandits to understand how
the increase in players affected the observation noise. Additionally we tested different unimodal performance functions
to see wether certian target values were more difficult hit. Finally by varying the gaussian white noise we observed how
