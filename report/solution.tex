...
values on both their arms. They way we measured performance was by looking at the reward for each observation
noise. By doing so we would find where the top observation noises are and the best one.
Following is a list of all parameters used for the Goore game:
\begin{itemize}
