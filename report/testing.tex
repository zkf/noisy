...
%    \end{gnuplot}
    ...
    \banditsetup{5.0}{0.5}{4.0}{0.5}{2 -- 64}{10 -- 1000}
    \end{minipage}
...
#    plot "../data/bandit/good-5.0,0.5\_bad-(0.5,4.5,0.5),0.5\_est-10.0,2.0\_num-5\_rounds-1000\_algo-UCB1.data" using (column(6)==1000?column(3):NaN):7
    ...
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \banditsetup{5.0}{0.5}{0.5 -- 4.5}{0.5}{5}{1000}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \banditsetup{6.5}{0.1 -- 5.0}{4.0}{0.1}{5}{10 -- 1000}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    set log x
    set xrange [4:1000]
    plot "../data/instantrewards/good-5.0,2.0\_bad-4.0,4.0\_est-10.0,0.5\_num-2\_obnoise-0.51\_rounds-1000\_reps-100000\_algo-LTS.data" using 1:(5-column(2)) title "\\textsc{lts: 0.51}", \
         "../data/instantrewards/good-5.0,2.0\_bad-4.0,4.0\_num-2\_rounds-1000\_reps-100000\_algo-UCB1.data" using 1:(5-column(2)) title "\\textsc{ucb1}"
    \end{gnuplot}
    \end{minipage}
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \banditsetup{5.0}{2.0}{4.0}{4.0}{2}{1 -- 1000}
    \end{minipage}
...
\begin{figure}[hbtp]
    ...
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \banditsetup{5.0}{0.5}{4.0}{0.1 -- 3.5}{5}{1000}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \gooresetup{30/70}{10 000}{In graph}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    \hspace*{7.5cm}
    \begin{minipage}[c]{0.49\textwidth}
    \gooresetup{30/70}{In graph}{10}
    \end{minipage}
\caption{Overview of Rounds and White noise}
\label{fig:ex11}
\end{figure}

It is important to have an observation noise close to the optimal observation noise, because as shown in Figure
\ref{fig:ex12} by diverting to far from it you start losing more and more reward for it. The drop is faster
towards zero then the other way of the optimal observation noise.
